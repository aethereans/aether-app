...
function makeCurrentBoardCrumb(context) {
    ...
    //   )
    // }
    return createCrumb('board', currentBoard.name, 'board/' + currentBoard.fingerprint, currentBoard.fingerprint);
}
function makeCurrentThreadCrumb(context) {
    ...
    if (typeof context.state.currentThread === 'undefined') {
        ...
        return createCrumb('thread', 'Not found', 'board/' +
            currentBoard.fingerprint +
            '/thread/' +
            context.state.currentThreadFp, context.state.currentThreadFp);
    }
