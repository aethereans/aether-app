...
Vue.component('a-sfwlist-icon', require('./components/a-sfwlist-icon.vue').default);
...
var Defaults = require('./components/locations/settingsscope/defaults.vue').default;
var Shortcuts = require('./components/locations/settingsscope/shortcuts.vue').default;
...
var SearchCommunity = require('./components/locations/searchscope/communitysearch.vue').default;
var SearchContent = require('./components/locations/searchscope/contentsearch.vue').default;
var SearchUser = require('./components/locations/searchscope/usersearch.vue').default;
/*----------  Routes  ----------*/
var routes = [
