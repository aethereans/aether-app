...
function serialize_clapi_AlwaysShowNSFWListStatusPayload(arg) {
  if (!(arg instanceof clapi_clapi_pb.AlwaysShowNSFWListStatusPayload)) {
    throw new Error(
      "Expected argument of type clapi.AlwaysShowNSFWListStatusPayload",
    );
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_AlwaysShowNSFWListStatusPayload(buffer_arg) {
  return clapi_clapi_pb.AlwaysShowNSFWListStatusPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}

function serialize_clapi_AlwaysShowNSFWListStatusResponse(arg) {
  if (!(arg instanceof clapi_clapi_pb.AlwaysShowNSFWListStatusResponse)) {
    throw new Error(
      "Expected argument of type clapi.AlwaysShowNSFWListStatusResponse",
    );
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_AlwaysShowNSFWListStatusResponse(buffer_arg) {
  return clapi_clapi_pb.AlwaysShowNSFWListStatusResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_AmbientLocalUserEntityPayload(arg) {
  if (!(arg instanceof clapi_clapi_pb.AmbientLocalUserEntityPayload)) {
    throw new Error(
      "Expected argument of type clapi.AmbientLocalUserEntityPayload",
    );
  }
  return new Buffer(arg.serializeBinary());
}
...
function deserialize_clapi_AmbientLocalUserEntityPayload(buffer_arg) {
  return clapi_clapi_pb.AmbientLocalUserEntityPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_AmbientLocalUserEntityResponse(arg) {
  if (!(arg instanceof clapi_clapi_pb.AmbientLocalUserEntityResponse)) {
    throw new Error(
      "Expected argument of type clapi.AmbientLocalUserEntityResponse",
    );
  }
  return new Buffer(arg.serializeBinary());
}
...
function deserialize_clapi_AmbientLocalUserEntityResponse(buffer_arg) {
  return clapi_clapi_pb.AmbientLocalUserEntityResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_AmbientStatusPayload(buffer_arg) {
  return clapi_clapi_pb.AmbientStatusPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_AmbientStatusResponse(buffer_arg) {
  return clapi_clapi_pb.AmbientStatusResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_AmbientsRequest(buffer_arg) {
  return clapi_clapi_pb.AmbientsRequest.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_AmbientsResponse(buffer_arg) {
  return clapi_clapi_pb.AmbientsResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_ExternalContentAutoloadDisabledStatusPayload(arg) {
  if (
    !(
      arg instanceof clapi_clapi_pb.ExternalContentAutoloadDisabledStatusPayload
    )
  ) {
    throw new Error(
      "Expected argument of type clapi.ExternalContentAutoloadDisabledStatusPayload",
    );
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_ExternalContentAutoloadDisabledStatusPayload(
  buffer_arg,
) {
  return clapi_clapi_pb.ExternalContentAutoloadDisabledStatusPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_ExternalContentAutoloadDisabledStatusResponse(arg) {
  if (
    !(
      arg instanceof
      clapi_clapi_pb.ExternalContentAutoloadDisabledStatusResponse
    )
  ) {
    throw new Error(
      "Expected argument of type clapi.ExternalContentAutoloadDisabledStatusResponse",
    );
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_ExternalContentAutoloadDisabledStatusResponse(
  buffer_arg,
) {
  return clapi_clapi_pb.ExternalContentAutoloadDisabledStatusResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_FEReadyRequest(buffer_arg) {
  return clapi_clapi_pb.FEReadyRequest.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_FEReadyResponse(buffer_arg) {
  return clapi_clapi_pb.FEReadyResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_HomeViewPayload(buffer_arg) {
  return clapi_clapi_pb.HomeViewPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_HomeViewResponse(buffer_arg) {
  return clapi_clapi_pb.HomeViewResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_ModModeEnabledStatusPayload(arg) {
  if (!(arg instanceof clapi_clapi_pb.ModModeEnabledStatusPayload)) {
    throw new Error(
      "Expected argument of type clapi.ModModeEnabledStatusPayload",
    );
  }
  return new Buffer(arg.serializeBinary());
}
...
function deserialize_clapi_ModModeEnabledStatusPayload(buffer_arg) {
  return clapi_clapi_pb.ModModeEnabledStatusPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_ModModeEnabledStatusResponse(arg) {
  if (!(arg instanceof clapi_clapi_pb.ModModeEnabledStatusResponse)) {
    throw new Error(
      "Expected argument of type clapi.ModModeEnabledStatusResponse",
    );
  }
  return new Buffer(arg.serializeBinary());
}
...
function deserialize_clapi_ModModeEnabledStatusResponse(buffer_arg) {
  return clapi_clapi_pb.ModModeEnabledStatusResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}

function serialize_clapi_NewViewPayload(arg) {
  if (!(arg instanceof clapi_clapi_pb.NewViewPayload)) {
    throw new Error("Expected argument of type clapi.NewViewPayload");
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_NewViewPayload(buffer_arg) {
  return clapi_clapi_pb.NewViewPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}

function serialize_clapi_NewViewResponse(arg) {
  if (!(arg instanceof clapi_clapi_pb.NewViewResponse)) {
    throw new Error("Expected argument of type clapi.NewViewResponse");
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_NewViewResponse(buffer_arg) {
  return clapi_clapi_pb.NewViewResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_NotificationsPayload(buffer_arg) {
  return clapi_clapi_pb.NotificationsPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_NotificationsResponse(buffer_arg) {
  return clapi_clapi_pb.NotificationsResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_OnboardCompleteStatusPayload(arg) {
  if (!(arg instanceof clapi_clapi_pb.OnboardCompleteStatusPayload)) {
    throw new Error(
      "Expected argument of type clapi.OnboardCompleteStatusPayload",
    );
  }
  return new Buffer(arg.serializeBinary());
}
...
function deserialize_clapi_OnboardCompleteStatusPayload(buffer_arg) {
  return clapi_clapi_pb.OnboardCompleteStatusPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function serialize_clapi_OnboardCompleteStatusResponse(arg) {
  if (!(arg instanceof clapi_clapi_pb.OnboardCompleteStatusResponse)) {
    throw new Error(
      "Expected argument of type clapi.OnboardCompleteStatusResponse",
    );
  }
  return new Buffer(arg.serializeBinary());
}
...
function deserialize_clapi_OnboardCompleteStatusResponse(buffer_arg) {
  return clapi_clapi_pb.OnboardCompleteStatusResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_PopularViewPayload(buffer_arg) {
  return clapi_clapi_pb.PopularViewPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_PopularViewResponse(buffer_arg) {
  return clapi_clapi_pb.PopularViewResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}

function serialize_clapi_SFWListDisabledStatusPayload(arg) {
  if (!(arg instanceof clapi_clapi_pb.SFWListDisabledStatusPayload)) {
    throw new Error(
      "Expected argument of type clapi.SFWListDisabledStatusPayload",
    );
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_SFWListDisabledStatusPayload(buffer_arg) {
  return clapi_clapi_pb.SFWListDisabledStatusPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}

function serialize_clapi_SFWListDisabledStatusResponse(arg) {
  if (!(arg instanceof clapi_clapi_pb.SFWListDisabledStatusResponse)) {
    throw new Error(
      "Expected argument of type clapi.SFWListDisabledStatusResponse",
    );
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_clapi_SFWListDisabledStatusResponse(buffer_arg) {
  return clapi_clapi_pb.SFWListDisabledStatusResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_SearchResultPayload(buffer_arg) {
  return clapi_clapi_pb.SearchResultPayload.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
function deserialize_clapi_SearchResultResponse(buffer_arg) {
  return clapi_clapi_pb.SearchResultResponse.deserializeBinary(
    new Uint8Array(buffer_arg),
  );
}
...
var ClientAPIService = (exports.ClientAPIService = {
  ...
  sendNewView: {
    path: "/clapi.ClientAPI/SendNewView",
    requestStream: false,
    responseStream: false,
    requestType: clapi_clapi_pb.NewViewPayload,
    responseType: clapi_clapi_pb.NewViewResponse,
    requestSerialize: serialize_clapi_NewViewPayload,
    requestDeserialize: deserialize_clapi_NewViewPayload,
    responseSerialize: serialize_clapi_NewViewResponse,
    responseDeserialize: deserialize_clapi_NewViewResponse,
  },
  sendNotifications: {
  ...
  sendAlwaysShowNSFWListStatus: {
    path: "/clapi.ClientAPI/SendAlwaysShowNSFWListStatus",
    requestStream: false,
    responseStream: false,
    requestType: clapi_clapi_pb.AlwaysShowNSFWListStatusPayload,
    responseType: clapi_clapi_pb.AlwaysShowNSFWListStatusResponse,
    requestSerialize: serialize_clapi_AlwaysShowNSFWListStatusPayload,
    requestDeserialize: deserialize_clapi_AlwaysShowNSFWListStatusPayload,
    responseSerialize: serialize_clapi_AlwaysShowNSFWListStatusResponse,
    responseDeserialize: deserialize_clapi_AlwaysShowNSFWListStatusResponse,
  },
  sendExternalContentAutoloadDisabledStatus: {
    ...
    requestSerialize:
      serialize_clapi_ExternalContentAutoloadDisabledStatusPayload,
    requestDeserialize:
      deserialize_clapi_ExternalContentAutoloadDisabledStatusPayload,
    responseSerialize:
      serialize_clapi_ExternalContentAutoloadDisabledStatusResponse,
    responseDeserialize:
      deserialize_clapi_ExternalContentAutoloadDisabledStatusResponse,
  },
  sendSFWListDisabledStatus: {
    path: "/clapi.ClientAPI/SendSFWListDisabledStatus",
    requestStream: false,
    responseStream: false,
    requestType: clapi_clapi_pb.SFWListDisabledStatusPayload,
    responseType: clapi_clapi_pb.SFWListDisabledStatusResponse,
    requestSerialize: serialize_clapi_SFWListDisabledStatusPayload,
    requestDeserialize: deserialize_clapi_SFWListDisabledStatusPayload,
    responseSerialize: serialize_clapi_SFWListDisabledStatusResponse,
    responseDeserialize: deserialize_clapi_SFWListDisabledStatusResponse,
  },
  sendSearchResult: {
