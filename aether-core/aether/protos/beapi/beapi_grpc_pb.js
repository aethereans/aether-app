...
function deserialize_beapi_AccessRequest(buffer_arg) {
  return beapi_beapi_pb.AccessRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_AccessResponse(buffer_arg) {
  return beapi_beapi_pb.AccessResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_BoardThreadsCountRequest(buffer_arg) {
  return beapi_beapi_pb.BoardThreadsCountRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_beapi_BoardThreadsCountResponse(arg) {
  if (!(arg instanceof beapi_beapi_pb.BoardThreadsCountResponse)) {
    throw new Error('Expected argument of type beapi.BoardThreadsCountResponse');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_beapi_BoardThreadsCountResponse(buffer_arg) {
  return beapi_beapi_pb.BoardThreadsCountResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_BoardsRequest(buffer_arg) {
  return beapi_beapi_pb.BoardsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_KeysRequest(buffer_arg) {
  return beapi_beapi_pb.KeysRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_KeysResponse(buffer_arg) {
  return beapi_beapi_pb.KeysResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_MintedContentPayload(buffer_arg) {
  return beapi_beapi_pb.MintedContentPayload.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_MintedContentResponse(buffer_arg) {
  return beapi_beapi_pb.MintedContentResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_PostsRequest(buffer_arg) {
  return beapi_beapi_pb.PostsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_PostsResponse(buffer_arg) {
  return beapi_beapi_pb.PostsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_ThreadPostsCountRequest(buffer_arg) {
  return beapi_beapi_pb.ThreadPostsCountRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_ThreadPostsCountResponse(buffer_arg) {
  return beapi_beapi_pb.ThreadPostsCountResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_ThreadsRequest(buffer_arg) {
  return beapi_beapi_pb.ThreadsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_ThreadsResponse(buffer_arg) {
  return beapi_beapi_pb.ThreadsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_TruststatesRequest(buffer_arg) {
  return beapi_beapi_pb.TruststatesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_TruststatesResponse(buffer_arg) {
  return beapi_beapi_pb.TruststatesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_VotesRequest(buffer_arg) {
  return beapi_beapi_pb.VotesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_beapi_VotesResponse(buffer_arg) {
  return beapi_beapi_pb.VotesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
