...
proto.beapi.ConnectToRemoteRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    requesterid: (f = msg.getRequesterid()) && proto.beapi.RequesterId.toObject(includeInstance, f),
    address: (f = msg.getAddress()) && mimapi_structprotos_pb.Address.toObject(includeInstance, f)
  };
...
/**
 * optional structprotos.Address Address = 2;
 * @return {?proto.structprotos.Address}
 */
proto.beapi.ConnectToRemoteRequest.prototype.getAddress = function() {
  return /** @type{?proto.structprotos.Address} */ (
    jspb.Message.getWrapperField(this, mimapi_structprotos_pb.Address, 2));
};


/** @param {?proto.structprotos.Address|undefined} value */
