...
let quotes: Quote[] = [
  ...
  {
    Quote:
      'Any sufficiently complicated computer program contains an ad hoc, informally–specified, bug–ridden, slow implementation of half of Lisp.',
  ...
  {
    Quote:
      'And on the pedestal these words appear: <br>‘My name is Ozymandias, king of kings: <br>Look on my works, ye Mighty, and despair!’ <br>Nothing beside remains.',
    Author: 'Ozymandias, Percy Bysshe Shelley',
  },
  {
    Quote:
      'The birds have vanished down the sky. <br>Now the last cloud drains away. <br><br>We sit together, the mountain and me, <br>until only the mountain remains.',
    Author: 'Li Bai 李白',
  },
  {
    Quote:
      'The fault, my dear Brutus, is not in our stars, <br>But in ourselves, that we are underlings.',
