<template>
  <router-link class="board-entity" :to="linkToBoard" :class="{'inflight': isInflightEntity, 'uncompiled': uncompiled}">
    ...
    <div class="flex-carrier actions" v-if="actionsVisible">
      <div class="actions-container">
        ...
        <a class="button is-danger" hasTooltip title="Subscribe" @click.prevent="subToBoard({'fp':boardFingerprint, 'notify':true})" v-show="!board.subscribed">
