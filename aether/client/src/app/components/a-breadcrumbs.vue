<template>
  <div class="breadcrumbs">
    <router-link class="breadcrumb root" to="/" title="Home">
      <img class="root-img" src="../ext_dep/images/logo-sm-h.png" alt="" :class="{'at-home': isAtHome}">
      <div class="breadcrumb-text" v-show="isAtHome">Home </div>
    </router-link>
    <router-link class="breadcrumb" v-for="bc in breadcrumbs"  :title="bc.VisibleName" :to="'/'+bc.Link">
      <img class="soft-chevron" src="../ext_dep/svg/softer-chevron.svg" alt="">
