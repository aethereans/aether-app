<template>
  <div class="header-container" :class="{'sidebar-closed': !sidebarOpen}">
    <div class="history-container">
      <a-header-icon icon="chevron-left" :class="{'disabled': !hasPrevious}" @click.native="goBackward" class="top-left-rounded-hover"></a-header-icon>
          ...
          <div class="dropdown-menu" id="dropdown-menu" role="menu">
            <div class="dropdown-content">
              ...
              <template v-if="!localUserReadOnly">
                <a-avatar-block nofingerprint="true" :user="$store.state.localUser" :clickable="true" :imageheight="96"></a-avatar-block>
                <hr class="dropdown-divider">
    ...
    <div class="windows-toggles-container" v-if="isWindows">
      <template v-if="isWindows10">
        <div class="windows-window-toggles">
          ...
          <div class="win-btn maximise" v-show="!maximised" @click="maximiseWindow">
            <span>&#xE922;</span>
          </div>
          <div class="win-btn restore" v-show="maximised" @click="restoreWindow">
            <span>&#xE923;</span>
          </div>
