<template>
  <div class="bootstrapper" v-if="containerVisible && (bootstrapInProgress || bootstrapRefreshInProgress || bootstrapRefreshComplete)">
    <div class="bootstrapper-carrier">
      <div class="bootstrap-message" v-if="bootstrapInProgress">
        <div class="spinner-container">
          <a-spinner :hidetext="true"></a-spinner>
        </div>
        <div class="text-carrier"><b>Catching up:</b> Downloading fresh content from Aether... (1-5 min.)</div>
      </div>
      <div class="bootstrap-message" v-if="bootstrapRefreshInProgress">
        <div class="spinner-container">
          <a-spinner :hidetext="true"></a-spinner>
        </div>
        <div class="text-carrier"><b>Catching up:</b> Compiling the entity graph...</div>
      </div>
      <div class="bootstrap-message" v-if="bootstrapRefreshComplete">
        <div class="text-carrier"><b>Catching up:</b> Complete. You now have the most recent content.</div>
      </div>
    </div>
  </div>
</template>
