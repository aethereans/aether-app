<template>
  <div id="app">
    <transition name="component-fade" mode="out-in">
      <div class="app-loader-container" v-show="!$store.state.onboardCompleteStatusArrived || !$store.state.firstRunAfterUpdateStatusArrived">
        <transition name="fade" appear>
          <a-main-app-loader v-show="!$store.state.onboardCompleteStatusArrived || !$store.state.firstRunAfterUpdateStatusArrived"></a-main-app-loader>
        </transition>
      </div>
    </transition>
    <transition name="fade" appear>
