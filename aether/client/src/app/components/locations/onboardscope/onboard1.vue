      ...
      <transition name="fade" appear>
        <div class="onboard1-container">
          ...
          <div class="developer-preview-notice">
            DEVELOPER PREVIEW
            <a-info-marker header="This is a preview build. It might break." text="<p>If it does, please let us know on the <a href='https://meta.getaether.net'>meta&nbsp;forum</a>.</p>"></a-info-marker>
          </div>
        </div>
      </transition>
