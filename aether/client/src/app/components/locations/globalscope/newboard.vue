  ...
  export default {
      ...
      return {
        boardComposerSpec: {
          ...
          fields: [{
            ...
            description: "Short, sweet, without spaces. It will be referred to as <i>b/yourcommunity</i>. This cannot be changed later.",
            ...
            description: "Optional. This is where you put the community rules you want to tell people about, if any. Markdown is available.",
    ...
    methods: {
      submitBoard(this: any, fields: any) {
        ...
        this.$router.push('/user/' + this.$store.state.localUser.fingerprint + '/boards')
