      ...
      return {
        threadComposerSpec: {
          ...
          fields: [{
            id: "threadName",
            visibleName: "Title",
            description: "Keep it short, consider using the original title if present.",
            placeholder: "",
            maxCharCount: 256,
            heightRows: 1,
            ...
            id: "threadLink",
            visibleName: "Link",
            description: "Optional. If it's an image, GIF or video, and you want it to have a preview, upload to a whitelisted host (Imgur, Gfycat, Giphy) and <b>link the file directly</b>.",
            ...
            id: "threadBody",
            visibleName: "Body",
            description: "Optional. Markdown is available.",
            placeholder: "",
            maxCharCount: 20480,
            heightRows: 10,
    ...
    methods: {
      submitThread(this: any, fields: any) {
        ...
        fe.SendThreadContent('', thread, function(resp: any) {
          ...
          vm.$router.push('/board/' + vm.$store.state.currentBoard.fingerprint + '/new')
        })
      }
    }
  }
