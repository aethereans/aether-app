  ...
  <div class="user-sublocation">
    <div class="user-root">
      ...
      <div class="user-data-field-container">
        ...
        <div class="user-data-field">
          <!-- {{timeSince($store.state.currentUserEntity.Creation)}} {{$store.state.currentUserEntity.Creation}} -->{{timeString($store.state.currentUserEntity.creation)}}
  ...
  export default {
    ...
    computed: {
      ...
      inflightEdits(this: any) {
        ...
        for (let val of this.$store.state.ambientStatus.inflights.keysList) {
          if (this.$store.state.currentUserEntity.fingerprint !== val.entity.provable.fingerprint) {
            continue
          }
    ...
    methods: {
      ...
      submitEditExistingUser(this: any, fields: any) {
        ...
        let vm = this
        fe.SendUserContent(this.$store.state.currentUserEntity.fingerprint, user, function(resp: any) {
          vm.toggleEditPane()
