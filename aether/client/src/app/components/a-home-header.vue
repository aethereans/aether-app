    ...
    <div class="center-container">
      <div class="header-container side-layout">
        ...
        <div class="header-subtext">
          Most popular content from your subbed communities
          <div class="infomark-container">
            <a-info-marker
              text="<p>If you've subbed to a community, and you have its notifications enabled, most interesting stuff in it will appear here.</p>"
            ></a-info-marker>
          </div>
        </div>
      </div>
