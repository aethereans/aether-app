    ...
    <router-link tag="div" class="sidebar-group status" to="/status">
      <div class="sidebar-group-header">
        ...
        <div class="infomark-container">
          <a-info-marker header="If both of the lights are green, everything is fine, and you can ignore this pane." text="<p>If you're seeing red lights, you should click <a href='#/status'><b>here</b></a> and see what's wrong. If it's not obvious, consider posting a screenshot of your status view to the forum, so we can help you better.</p><p>An untreated warning or error can slow down updates, or completely block you from receiving them.</p>"></a-info-marker>
        </div>
      </div>
  ...
  export default {
    ...
    computed: {
      ...
      refresherState(this:any):string {
        ...
        let rawrefreshts = this.ambientStatus.frontendambientstatus.lastrefreshtimestamp
        if (rawrefreshts === 0) {
          return 'Unknown'
        }
