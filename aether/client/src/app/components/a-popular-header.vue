  ...
  <div class="view-header">
    ...
    <div class="center-container">
      <div class="header-container side-layout">
        ...
        <div class="header-subtext">Most popular content from the network
          <div class="infomark-container">
            <a-info-marker text="<p>Popular shows the most interesting content from the network. </p>"></a-info-marker>
          </div>
        </div>
      </div>
    </div>
