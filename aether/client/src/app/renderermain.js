...
=            Spell checker             =
========================================*/
var HunspellAsm = require('hunspell-asm');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, browserWindowProvider.loadDictionary('en', path.join(__dirname, '../app/dicts/en-US.dic'), path.join(__dirname, '../app/dicts/en-US.aff'))];
            case 2:
                _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, browserWindowProvider.loadDictionary('en', 'src/app/ext_dep/dicts/en-US.dic', 'src/app/ext_dep/dicts/en-US.aff')];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5:
